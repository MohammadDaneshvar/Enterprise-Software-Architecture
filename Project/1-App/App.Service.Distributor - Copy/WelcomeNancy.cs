    ...
    public class WelcomeModule : NancyModule
    {
        public WelcomeModule()
        {
            ...
            foreach (var command in commands)
            {
                ...
                var makeHandler = this.GetType().GetMethod("MakeHandler", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance)
        ...
        private Func<object, object> MakeHandler<T>()
        {
            return _ =>
            {
